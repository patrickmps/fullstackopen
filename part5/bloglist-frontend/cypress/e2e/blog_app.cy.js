describe('Blog app', function () {
  ...
  describe('When logged in', function () {
    ...
    it('blogs are ordered according to likes', function () {
      cy.createBlog({ title: 'The title with the most likes', author: 'first', url: 'https://cypress.io' })
      cy.createBlog({ title: 'The title with the second most likes', author: 'second', url: 'https://cypress.io' })
